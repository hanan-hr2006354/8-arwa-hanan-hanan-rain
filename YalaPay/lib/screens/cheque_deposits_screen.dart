...
class ChequeDepositsScreen extends ConsumerWidget {
                                  ...
                                  children: [
                                    ...
                                    ButtonBar(
                                      ...
                                      children: [
                                        ElevatedButton(
                                          onPressed: () async {
                                            final returnReasons = await ref.read(depositsRepositoryProvider).loadReturnReasons();
                                            _showUpdateDialog(context, ref, deposit["id"], returnReasons);
                                          },
  ...
  void _showUpdateDialog(BuildContext context, WidgetRef ref, String depositId, List<String> returnReasons) {
          ...
          builder: (context, setState) {
            return AlertDialog(
              ...
              actions: [
                TextButton(
                  onPressed: () async {
                    await ref.read(depositsRepositoryProvider).updateDepositStatus(
                      depositId,
                      selectedStatus,
